...
<body>
    ...
    <div class="main">
        ...
        <div class="topbar">
            ...
            <!-- FOTO USER BISA DIKLIK KE PROFILE -->
            <div class="user">
        ...
        <div class="profile-container">
            <div class="profile-card">
                ...
                <div class="profile-header">
                    <img src="{{ asset('image/profile.png') }}" alt="Admin" class="profile-avatar">
                    <h1 class="profile-name">Healthyroll Indonesia</h1>
                    <div class="profile-role">Owner & Founder</div>
                </div>
                ...
                <div class="profile-body">
                    <div class="profile-info">
                        <table>
                            <tr>
                                <td>Nama Lengkap</td>
                                <td>Healthyroll Indonesia</td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>admin@healthyroll.id</td>
                            </tr>
                            <tr>
                                <td>Telepon</td>
                            ...
                            <tr>
                                <td>Lokasi</td>
                                <td>Pasuruan, Indonesia</td>
                            </tr>
                            <tr>
                                <td>Role</td>
                                <td><span style="background:#6c5ce7;color:white;padding:6px 16px;border-radius:30px;font-size:13px;font-weight:600;">Super Admin</span></td>
                            </tr>
                        </table>
                    </div>

                    <div class="bio-section">
                        <h3>Tentang Healthyroll Indonesia</h3>
                        <p>Healthyroll Indonesia adalah brand makanan sehat berbahan dasar ayam yang menyediakan berbagai varian chicken roll premium dengan rasa autentik Indonesia.</p>
                        <p>Kami berkomitmen menghadirkan makanan sehat, enak, dan terjangkau. Saat ini telah memiliki lebih dari <strong>127 outlet</strong> di seluruh Indonesia dan terus berkembang pesat dengan rating Google <strong>4.9/5.0</strong> dari ribuan pelanggan.</p>
                    </div>

                    <div class="profile-actions">
                        <a href="#" class="btn btn-primary" style="text-decoration: none">Edit Profil</a>
                        <a href="#" class="btn btn-secondary" style="text-decoration: none">Ganti Password</a>
                    </div>
                </div>
            </div>
            ...
            <div class="profile-stats">
                <div class="profile-stat-card">
                    ...
                    <div class="cardName">Total Outlet</div>
                    <div class="iconBx">
                        <ion-icon name="storefront-outline"></ion-icon>
                    </div>
                </div>
                <div class="profile-stat-card">
                    <div class="numbers">8.542</div>
                    <div class="cardName">Pelanggan Aktif</div>
                    <div class="iconBx">
                ...
                <div class="profile-stat-card">
                    ...
                    <div class="cardName">Rating Google</div>
                    <div class="iconBx">
