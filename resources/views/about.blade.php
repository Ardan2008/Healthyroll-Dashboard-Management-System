...
<body>
    ...
    <div class="main">
        ...
        <h1 class="page-title">About HealthyRoll Indonesia</h1>

        <div class="about-section summary">
            <p>
                <strong>HealthyRoll Indonesia</strong> adalah usaha kuliner kreatif yang menghadirkan <b>Chicken Roll sehat, bergizi, dan praktis</b>. Kami berkomitmen menciptakan makanan cepat saji yang tetap menyehatkan dan membanggakan produk lokal.
            </p>
        </div>

        <div class="content-grid">
            <div class="about-card identity-card">
                <h2><ion-icon name="receipt-outline"></ion-icon> Identitas Perusahaan</h2>
                <p>Nama <b>HealthyRoll Indonesia</b> dipilih karena menggambarkan identitas produk utama yaitu makanan Chicken Roll sehat dan praktis.</p>
                <p>Kata <b>“Healthy”</b> menonjolkan konsep makanan bergizi dan rendah minyak, sedangkan <b>“Roll”</b> menggambarkan bentuk produk gulungan ayam yang unik dan menarik.</p>
                <p>Penambahan kata <b>“Indonesia”</b> menunjukkan kebanggaan terhadap produk lokal.</p>
            </div>

            <div class="about-card vision-card">
                <h2><ion-icon name="eye-outline"></ion-icon> Visi dan Misi</h2>
                
                <h3>Visi</h3>
                <p>Menjadi pelopor makanan cepat saji sehat dan inovatif di Indonesia yang digemari semua kalangan.</p>

                <h3>Misi</h3>
                <ul>
                    <li>🐔 Kualitas tinggi & bahan segar</li>
                    <li>💡 Inovasi rasa & kemasan</li>
                    <li>🌱 Produksi ramah lingkungan</li>
            ...
            <div class="about-card logo-card">
                <h2><ion-icon name="pricetag-outline"></ion-icon> Logo Perusahaan</h2>
                <h3>Deskripsi Logo:</h3>
                <p>Logo berbentuk ayam bergulung (roll) dengan dominasi warna <b>hijau</b> dan <b>orange</b>.</p>
                <ul>
                    <li><b>Hijau</b> : melambangkan kesegaran, kesehatan, dan bahan alami.</li>
                    <li><b>Orange</b>: melambangkan semangat, kreativitas, dan cita rasa yang menggugah selera.</li>
                    <li>Bentuk gulungan ayam menunjukkan inovasi dan keunikan produk.</li>
                </ul>
                <h3>Makna Logo:</h3>
                <p>Melambangkan semangat HealthyRoll Indonesia untuk menghadirkan makanan sehat, bergizi, dan modern bagi semua kalangan.</p>
            </div>

            <div class="about-card motto-goals-card">
                <h2><ion-icon name="flag-outline"></ion-icon> Motto & Tujuan</h2>
                
                <h3 class="motto-text">"Sehatnya Nampol, Praktis Setiap Saat."</h3>
                <p class="motto-meaning">Motto ini mencerminkan nilai utama perusahaan: menyajikan makanan sehat yang tetap lezat dan mudah dinikmati kapan pun dan di mana pun.</p>

                <h3>Tujuan Utama</h3>
                <ol class="goals-list">
                    <li>Menyediakan makanan cepat saji yang sehat.</li>
                    <li>Meningkatkan kesadaran pola makan sehat.</li>
                    <li>Mengembangkan produk lokal.</li>
                    <li>Membuka peluang usaha kreatif.</li>
                </ol>
            </div>
        </div>
    </div>
