        ...
        <div class="messages-container">
            <div class="messages-header">
                ...
                <div class="messages-stats">
                    <span class="stat unread"><strong>12</strong> Belum Dibaca</span>
                    <span class="stat total"><strong>89</strong> Total Pesan</span>
                </div>
            </div>
            ...
            <div class="messages-list">
                ...
                <div class="message-item unread">
                    <div class="message-avatar">
                        <img src="{{ asset('image/messages/001.png') }}" alt="Jours">
                    </div>
                    <div class="message-content">
                        ...
                        <div class="message-preview">
                            <strong>Mau pesan 50 box Chicken Roll Keju</strong>
                            <p>Buat acara ulang tahun anak saya, bisa dikirim besok pagi?</p>
                        </div>
                        <div class="message-actions">
                            <button class="btn-reply">Balas</button>
                            <button class="btn-mark">Tandai Dibaca</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="message-item">
                    <div class="message-avatar">
                        <img src="{{ asset('image/messages/002.png') }}" alt="Olivia">
                    </div>
                    <div class="message-content">
                        <div class="message-info">
                            <h4>Olivia Grace Kensington</h4>
                            <span class="time">30 menit lalu</span>
                        </div>
                        <div class="message-preview">
                            <strong>Pesanan sudah sampai, makasih ya!</strong>
                            <p>Chicken Roll Sambalnya enak banget! Anak-anak suka semua</p>
                        </div>
                        <div class="message-actions">
                            <button class="btn-reply">Balas</button>
                            <button class="btn-mark">Tandai Dibaca</button>
                ...
                <div class="message-item important">
                    <div class="message-avatar">
                        <div class="avatar-placeholder">FR</div>
                    </div>
                    <div class="message-content">
                        <div class="message-info">
                            <h4>Franchise Jakarta Selatan</h4>
                            <span class="time">1 jam lalu</span>
                            <span class="label-important">PENTING</span>
                        </div>
                        <div class="message-preview">
                            <strong>Laporan Penjualan Bulan Ini</strong>
                            <p>Omzet naik 28% dari bulan lalu! Terima kasih tim pusat</p>
                        </div>
                        <div class="message-actions">
                            <button class="btn-reply">Balas</button>
                            <button class="btn-mark">Tandai Dibaca</button>
                ...
                <div class="message-item">
                    <div class="message-avatar">
                        <img src="{{ asset('image/messages/003.png') }}" alt="Liam">
                    </div>
                    <div class="message-content">
                        <div class="message-info">
                            <h4>Liam Theodore Harrison</h4>
                            <span class="time">2 jam lalu</span>
                        </div>
                        <div class="message-preview">
                            <strong>Ada promo bundling gak?</strong>
                            <p>Mau beli banyak buat kantor nih, ada diskon khusus gak ya?</p>
                        </div>
                        <div class="message-actions">
                            <button class="btn-reply">Balas</button>
                            <button class="btn-mark">Tandai Dibaca</button>
                ...
                <div class="message-item unread">
                    <div class="message-avatar">
                        <img src="{{ asset('image/messages/004.png') }}" alt="Luna">
                    </div>
                    <div class="message-content">
                        <div class="message-info">
                            <h4>Luna Adeline Moreau</h4>
                            <span class="time">4 jam lalu</span>
                        </div>
                        <div class="message-preview">
                            <strong>Kritik & Saran</strong>
                            <p>Tolong tambahin varian mentai bakar dong, pasti laris!</p>
                        </div>
                        <div class="message-actions">
                            <button class="btn-reply">Balas</button>
                            <button class="btn-mark">Tandai Dibaca</button>
